...
class my_node (Node):
    ...
    def timer_call(self):
        ...
        latitude_value = str(self.list_S[0])
        latitude_direction = self.list_S[1]
        longitude_value = str(self.list_S[2])
        longitude_direction = self.list_S[3]
        altitude_value = self.list_S[4]
        ...
        hdop = float(self.list_S[5])
        lat_std_dev = float(self.list_S[6])
        lon_std_dev = float(self.list_S[7])
        alt_std_dev = float(self.list_S[8])
